...
import { getUser, healthCheck, lookupUser, registTenantAdmin } from './app';
...
app.get('/user/pool/:id', lookupUser);

/** Get user attributes */
app.get('/user/:id', getUser);

/** Provision a new tenant admin user */
app.post('/user/reg', registTenantAdmin);
...
//   // Delete User Table
//   cognitoUsers
//     .deleteTable(configuration.table.user)
...
//   // Delete Tenant Table
//   cognitoUsers
//     .deleteTable(configuration.table.tenant)
//     .then(function (response) {})
//     .catch(function (err) {
...
//   cognitoUsers
//     .deleteTable(configuration.table.product)
//     .then(function (response) {})
//     .catch(function (err) {
...
//   // Delete Order Table
//   cognitoUsers
//     .deleteTable(configuration.table.order)
//     .then(function (response) {})
//     .catch(function (err) {
